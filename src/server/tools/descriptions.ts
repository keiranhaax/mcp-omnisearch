export const tool_descriptions = {
	web_search:
		'Search: find web pages, articles, or data. Use Brave/Kagi for operators, Exa for semantic or deep search, Tavily for factual results, and You for LLM-ready snippets.',
	github_search:
	...
	web_extract:
		'Extract/Process: read or process known URLs. Firecrawl handles scrape/crawl/map/extract/actions/search; Exa handles contents/similar; Tavily extracts; Kagi summarizes.',
	brave_llm_context:
